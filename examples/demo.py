""" A demonstration to start with, based on a He-3 project in the KGB Lab, Stanford
"""
import time
import math
import threading
...
if __name__ == '__main__':
    gui=DemoGUI(kernels.Galileo, s07.JanisS07PAR124MI, s07.JanisS07Controller)
    gui.start()